...
from service_platform.service.ai.scoring_and_ranking.schema import (
...
from service_platform.service.ai.match_and_filter.schema import (
    ExclusionLabel,
    InclusionLabel,
)
from service_platform.service.ai.llms.chat_completion import AzureOpenAIChatCompletion
from service_platform.service.ai.llms.llm_schema import (
    Model,
    MultiGenerationsResponse,
    ParseType,
)
from service_platform.service.ai.llms.llm_client import LLMClient
from service_platform.service.ai.llms.prompt import (
    GetTopTrialPrompt,
...
class BatchRanker:
    ...
    async def get_score_batch(
        ...
        try:
            ...
            print(f"Error in get_score_batch: {e}")
            return {}