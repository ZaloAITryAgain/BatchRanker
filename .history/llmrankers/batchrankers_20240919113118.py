        ...
        try:
            ...
            score_batch_response: BatchScoringResponseType = (
                await self.llm_client.astructure_completion_with_prompt(
                    ...
                    response_model=TrialScoringBatchResponse if use_COT else TrialScoringNoCOTBatchResponse,
                    model=self.llm,
            ...
            logger.info(f"Total completion tokens: {score_batch_response.completion_tokens}")
            logger.info(f"Total prompt tokens: {score_batch_response.prompt_tokens}")
