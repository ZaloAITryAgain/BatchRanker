    ...
    def _patch_structure_completion(self):
        ...
        def patched_from_response(
            ...
            return MultiGenerationsResponse(
                results=results,
                completion_tokens=sum(int(choice.usage.completion_tokens) for choice in completion.choices),
                prompt_tokens=sum(int(choice.usage.prompt_tokens) for choice in completion.choices),
            )
