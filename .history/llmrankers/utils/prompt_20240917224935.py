...
class SetwiseRankRelevancePrompt(BasePromptFunction):
    ...
    def system(self):
        ...
        if self.use_COT:
            prompt += (
                ...
                "1. For each document, analyze its title and summary in relation to the query. Provide a brief explanation and an initial relevance score (0-100).\n"
                ...
                "Summary: 'This document covers the basics of machine learning algorithms and their applications.'\n"
                "Document 2:\n"
                "Title: 'Introduction to Data Science'\n"
                "Summary: 'This document provides an overview of data science concepts and methodologies.'"
                "\n-----\n"
                ...
                "Final Relevance Scores: Document 1 (80), Document 2 (60)\n"
            )
        return prompt
    ...
    def user(self):
        ...
        for i, document in enumerate(self.documents, 1):
            self.key_to_document[i] = document["_id"]
            user_prompt += (
                f"Document {i}:\n"
                f"Title: {document['_source']['metadata']['brief_title']}\n"
                f"Summary: {document['_source']['metadata']['brief_summary']['textblock']}\n"
            )
